<template>
    <Listbox as="div" v-model="hostStore.selectedHostIdentifier">
        ...
        <div class="relative mt-1">
            ...
            >
                <ListboxOptions
                    class="absolute z-20 mt-1 max-h-60 w-full overflow-auto rounded-md shadow-md bg-white dark:bg-gray-800 py-1 border border-gray-200 dark:border-gray-700 ring-1 ring-brand ring-opacity-5 focus:outline-none text-sm"
                >
                    <ListboxOption
                        as="template"
