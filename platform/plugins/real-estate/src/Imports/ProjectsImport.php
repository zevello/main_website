...
class ProjectsImport implements ToModel, WithValidation, WithChunkReading, WithHeadingRow, WithMapping
{
    ...
    public function model(array $row)
    {
        ...
        $project->categories()->sync(array_filter(Arr::get($row, 'categories', [])));
        $project->features()->sync(array_filter(Arr::get($row, 'features', [])));
    ...
    public function map($row): array
    {
        ...
        $project = apply_filters('real_estate_projects_import_row_data', [
