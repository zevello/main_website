...
@section('content')
    ...
    <div class="max-width-1200">
        ...
        <div
            class="wrapper-list-social-login-options"
            @style(['display:none' => !SocialService::setting('enable')])
        >
            @foreach (SocialService::getProviders() as $provider => $item)
                ...
                >
                    ...
                    <div
                        class="enable-social-login-option-wrapper"
                        @style(['display:none' => !SocialService::getProviderEnabled($provider)])
                    >
