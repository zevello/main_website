...
<head>
    ...
    >
    <link
        href="{{ BaseHelper::getGoogleFontsURL() }}/css?family=Lato:400,700%7cPoppins:200,400,500,700"
        rel="stylesheet"
    >
...
<body>
    ...
    @endphp
    <div
        class="bg-gradient-to-r from-cyan-500 to-blue-500 bg-opacity-25 min-h-screen h-auto justify-center items-center py-20">
